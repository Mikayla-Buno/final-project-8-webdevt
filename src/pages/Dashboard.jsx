...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[rgba(169,214,229,0.1)] via-[rgba(232,196,196,0.1)] to-[rgba(169,214,229,0.15)] py-10 px-4">
      <div className="container">
        
        {/* Welcome Banner */}
        <div className="card bg-gradient-to-r from-[var(--blue-munsell)] to-[var(--charcoal)] text-white p-8 mb-10 shadow-lg">
          <h1 className="text-4xl font-bold mb-2">
            Welcome aboard, {user?.name || 'Traveler'}! 🛫
          </h1>
          <p className="text-[rgba(255,255,255,0.85)] text-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card p-6">
            <h2 className="text-xl font-semibold mb-4 flex items-center gap-2 text-[var(--charcoal)]">
